...
>
>-**Verwalten des Federated Data Model**
>-**Föderiertes Datenmodell anzeigen**
>
>Weitere Informationen zu den erforderlichen Berechtigungen finden Sie im [Handbuch zur Zugriffssteuerung](/help/governance-privacy-security/access-control.md).

Ein Datenmodell ist ein Satz von Schemata, Zielgruppen und den Verknüpfungen zwischen ihnen. Sie können Modelle verwenden, um die Daten Ihrer Datenbank in Ihren Audiences zu kombinieren.
...
2. Füllen Sie das angegebene Formular aus, um den Link zu definieren:
   ...
   * **1:1**: Eine Entität in der Quelltabelle kann maximal mit einer Entität in der Zieltabelle in Beziehung stehen.
   ...
   ![Die Schaltfläche mit dem Plussymbol wird hervorgehoben, sodass Sie einen Link mit mehreren Joins für das Modell erstellen können.](assets/models/multi-join.png){zoomable="yes"}
...
2. Wählen Sie die Schaltfläche ![](assets/models/do-not-localize/Smock_AddCircle_18_N.svg) neben dem Quellen-Join aus und ziehen Sie den Pfeil in Richtung Ziel-Join, um die Verbindung herzustellen.
